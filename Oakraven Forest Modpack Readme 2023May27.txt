...
- Oaks Monobikes (Single wheel motorcycles)
- Oaks New Trucks (Vehicles and a Mobile Garage)
- Oaks Spawning (New entities and spawning features)
- Oaks Starter Chest (Class based chests with starter resources
- Oaks Spiders Plus (Adds yet even more spiders and spider variants but restricted to the Wasteland)
- Oaks Escape Key Information Panel (Provides instructions and information about modpack key features)
- On/Off Lights (Custom Lighting)
- Oak Traps (Custom Traps)
- Oak Modpack UI (Custom HUD features)
- Oaks Replace Mod (Block type replacements and additions)
- Oaks Dragon Cannon (Custom Weapon)
- Oaks New Weapons (Custom Weapons)
- Oaks Space Ship Supply Drop (Futuristic flyover in place of regular plane and supply crate)
- Oaks Torches Lights (A collection of wood burning lights)
- Oaks Water Wells (A variety of custom water sources such as wells and stand pipes that can be placed within a player's boundaries)
- Oaks Rock Drills (Provides a gentle resource trickle for underground materials while out questing)
- Oaks Draw Bridges (A variety of walkways the act like horizontal plane draw bridges)
- Oaks Cooking Stations (Blenders, Mincing Machine, and Stove/Oven type appliances)
- Oaks Sign Cupboards (More storage choice variety)
- Oaks Power Things (Renewable power solutions)
- Oaks Hydroponic Farming (Farm underground with good returns, new crops, and a few new meals...and Fireflies)
- Oaks Fish Farm (Craft fish farm plots, place a starter kit, let them grow, harvest and eat)
- Oaks Chicken Coops (Find Baby Chicks in nests, place them in a Coop, reap the rewards)
- Oaks Bee Hives (Find Queen Bees, Craft Bee Hives, Collect Honey Comb and make some nice treats)
...
- Old West Migration (Expands the Old West Tiling and POI Count)
...
In addition, some Addons that are powered by 0-Score and 0-XNPCCore and bundled directly into 1-OakModpackCore are as follows:
...
Xyth - Created the 1-NPCXSpiderPack and 1-NPCXBirdPack.
...
Oakraven - Created Oakraven Forest Collection and Modpack assets.
...
arramus - Supported the Oakraven Forest Collection with NPCMod and Addon integration, 2-NPCXSpiderPack-ColonyExpansion, Fox things, Clear Bulletproof Glass, Old West Migration, xml, compilation, distribution, quality control balancing, and even added the odd icon or two. 
...
================================================
=== (NPC Mod) 0-Score, 0-XNPCCore and Addons === 
================================================
...
This modlet is cared for by closer_ex and can provide Modpacks and Overhauls with custom Main Menu Background images that are shown randomly.
This provides a very nice feature to personalise and highlight different aspects of what players can experience.
...
FilUnderscore kindly gave permission to bundle 'Improved Hordes' into the Oakraven Forest Modpack.
Apart from adding some custom entities to the entitygroups spawning list, it remains true to FilUnderscore's vision and function
Full terms of use and a detailed overview can be found here: https://community.7daystodie.com/topic/26781-improved-hordes-a206/
In addition, the mod also contains its own supporting documentation which allows end users to customize their own experiences.
Thank you for kind permission to bundle.
